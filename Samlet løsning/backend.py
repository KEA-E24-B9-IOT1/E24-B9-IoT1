...
left_blinker=NeoPixel(Pin(pin_neoring,Pin.OUT),0)  #Venstre blinklys
right_blinker=NeoPixel(Pin(pin_neoring,Pin.OUT),4) #Højre blinklys
# Buttens
...
def trigger_alarm(r,g,b,): #neoring, lb, rb
    ...
    neopixel_flash(r,g,b, left_blinker)
    neopixel_flash(r,g,b, right_blinker)
